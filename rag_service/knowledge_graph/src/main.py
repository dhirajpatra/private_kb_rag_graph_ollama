# graph_service/knowledge_graph/src/main.py
import warnings
import sys
import shutil
import urllib.parse
...
sys.path.append(str(Path(__file__).parent.parent.parent))  # Adjust based on your actual structure
...
from .document_sources.youtube import *
from .shared.common_fn import *
from .make_relationships import *
from .document_sources.web_pages import *
